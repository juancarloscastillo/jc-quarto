...
description: Este curso se centra en inferencia, asociación y reporte, y se dicta el 2do semestre en el segundo año de la carrera.
categories: [cursos]
# Date published
date: "2026-08-01"  #year-
...
::: {.button}
[<i class="bi bi-link-45deg"></i>](https://correlacional.metodos-facso.org/){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button" style="margin-top: 0em;"}
:::

::: {.button}
[<i class="bi bi-github"></i>](https://github.com/cursos-metodos-facso/correlacional-2026){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button" style="margin-top: 0em;"}
:::
:::

Link al sitio del curso, versión 2026: [https://correlacional.metodos-facso.org/](https://correlacional.metodos-facso.org/) 
