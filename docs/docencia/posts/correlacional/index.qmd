...
::: {.button}
[<i class="bi bi-link-45deg"></i>](https://correlacional.netlify.app){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button" style="margin-top: 0em;"}
:::

::: {.button}
[<i class="bi bi-github"></i>](https://github.com/cursos-metodos-facso/correlacional){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button" style="margin-top: 0em;"}
:::
:::
