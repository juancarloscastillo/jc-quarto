...
about:
  ...
  links:
    - icon: file-slides-fill
      href: /presentations/invalsi-2022/INVALSI_2022-focused-on-radical-.html
    - icon: camara-video-fill
      href: https://www.youtube.com/watch?v=8kpOp__ZyVU
---
# #- icon: github
#  icon_pack: fab
#  name: Github
...
Daniel Miranda, Juan-Carlos Castillo (2022). *Youth Dispositions to Participate in Disruptive and Pacific Actions*.  Conferece INVALSI  Data -  A Tool for Teaching and Scientific Research . Rome
