...
The basic workflow is pretty much the same as before, and you can see it [here](https://juancarloscastillo.github.io/jc-quarto/blog/posts/zotero-academic/). Here I will explain the main changes we need to make to adapt the function to Quarto.
