...
This post is outdated, as I no longer use the hugo-academic theme for my website. However, I keep it here as it might be useful for some people. If you want to know about the alternative for linking Zotero entries to my **Quarto website**, check [this post](/blog/posts/quarto-zotero-hook/index.html).
:::
