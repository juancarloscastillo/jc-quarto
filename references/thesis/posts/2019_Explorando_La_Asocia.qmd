...
about:
  ...
  links:
    ...
    - icon: file-pdf-fill
      href: https://www.dropbox.com/s/r27td53mfexbwpa/Tesis_gbeckv.pdf
---
- icon: file
  icon_pack: fa
  name: Documento
  web: https://www.dropbox.com/s/r27td53mfexbwpa/Tesis_gbeckv.pdf
...
Beck, Guillermo (2019). *Explorando La Asociación Entre Redes de Contacto Ocupacionales y La Justificación de La Desigualdad Social En Chile*.  Magister En Sociología - Pontificia Universidad Católica de Chile. Santiago de Chile
