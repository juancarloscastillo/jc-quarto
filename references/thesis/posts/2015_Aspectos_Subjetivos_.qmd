...
about:
  ...
  links:
    ...
    - icon: file-pdf-fill
      href: documents/pdf/TesisAlexTorresMeritocracia.pdf
---
- icon: file
  icon_pack: fa
  name: Documento
  web: documents/pdf/TesisAlexTorresMeritocracia.pdf
...
Torres, Alex (2015). *Aspectos Subjetivos de La Meritocracia y Su Relación Con La Percepción de La Desigualdad En Chile*.  Magister En Psicología Social Comunitaria - Pontificia Universidad Católica de Chile. Santiago de Chile
